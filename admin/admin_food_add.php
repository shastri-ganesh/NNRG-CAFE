...
?>
    ...
    <title>Update menu detail | NNRG-CÁFE</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin mt-auto w-50">
        ...
        <form method="POST" action="admin_food_add.php" class="form-floating" enctype="multipart/form-data">
            ...
            <input type="hidden" name="s_id" value="<?php echo $_SESSION['shop_id']; ?>">
            <div class="alert alert-info mb-2"><i class="bi bi-shop me-1"></i>Adding item to: <strong>
...
?>
            ...
            <div class="form-floating mb-2">
                <input type="number" step=".25" min="0.00" max="999.75" class="form-control" id="f_price"
                    placeholder="Price (INR)" name="f_price" required>
