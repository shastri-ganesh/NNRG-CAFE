...
<body class="d-flex flex-column h-100">
    ...
    <?php
            if(isset($_GET["search"])){
                ...
                // UPDATED QUERY: Added c.c_username and c.c_phone to SELECT statement
                $query = "SELECT orh.orh_id,orh.orh_ordertime,c.c_firstname,c.c_lastname,c.c_username,c.c_phone,orh.orh_orderstatus,p.p_amount,s.s_name,orh.t_id
            ...
            <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-3">
                ...
                <thead class="bg-light">
                    <tr>
                        ...
                        <!-- NEW COLUMNS: Added Roll Number and Phone -->
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <!-- NEW DATA CELLS: Added Username and Phone display -->
