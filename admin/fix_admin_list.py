...
with open('/Users/ganeshshastri/Developer/public_html/admin/admin_order_list.php', 'r') as file:
    content = file.read()
...
with open('/Users/ganeshshastri/Developer/public_html/admin/admin_order_list.php', 'w') as file:
    file.write(content)
